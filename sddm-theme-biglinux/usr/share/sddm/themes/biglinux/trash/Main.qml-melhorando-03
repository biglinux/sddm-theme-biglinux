...
Item {
    ...
    MouseArea {
            ...
            initialItem: Login {
                ...
                SessionButton {
                    ...
                    background: Rectangle {
                        ...
                        radius: height / 2 // Isso cria bordas arredondadas
                    ...
                    contentItem: Text {
                        ...
                        leftPadding: 20 // Aumentando o padding esquerdo
                        rightPadding: 20 // Aumentando o padding direito
        ...
        ColumnLayout {
            ...
            // Nova linha para botões de ação
            RowLayout {
                id: actionbutton
